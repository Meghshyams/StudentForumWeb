...
<body text="#0066cc" link=white alink=white vlink=white >
   ...
   <div style="border-style:solid;background-image:url('images/bgblue.jpg');border-color:#0088cc;border-width:5px" >
    ...
    <font face=impact size=6 color=white >The Student Room</font>
    </div>
    <center>
        <br />
        <table style="width:500px">
            ...
            <tr align=left >
                <td>
                    ContactNo</td>
                <td>
                    <asp:TextBox ID="txtContactNo" runat="server" Width="400px" MaxLength="12"></asp:TextBox>
                </td>
            </tr>
            <tr align=left >
                <td>
            ...
            <tr align=left >
                <td>
                    Confirm</td>
                <td>
                    <asp:TextBox ID="txtConfirm" runat="server" TextMode="Password" MaxLength="15"></asp:TextBox>
            ...
            <tr align=left >
                <td>
                    <a href="Index.aspx"><img src="Images/home.png" height=50 /></a>
                </td>
                <td>
