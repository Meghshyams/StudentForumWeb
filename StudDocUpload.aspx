<%@ Page Title="" Language="C#" MasterPageFile="~/StudMasterPage.master" AutoEventWireup="true" CodeFile="StudDocUpload.aspx.cs" Inherits="StudDocUpload" %>
...
<asp:SqlDataSource ID="sqlDoc" runat="server" 
    ...
    <InsertParameters>
        ...
        <asp:ControlParameter ControlID="hfDate" Name="UploadDate" PropertyName="Value" 
            Type="DateTime" />
        <asp:Parameter DefaultValue="1" Name="HitCount" Type="Int32" />
    </InsertParameters>
    <UpdateParameters>
